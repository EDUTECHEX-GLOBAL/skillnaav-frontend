...
function TeamPage() {
  ...
  <meta
    name="description"
    content="Meet the team behind Skill Naav — the innovators, developers, and creators building the future of internship discovery and skill-based career navigation. Also searched as SkillNaav."
  />
</Helmet>
      <Navbar />
