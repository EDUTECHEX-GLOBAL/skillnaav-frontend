...
function FaqPage() {
  ...
  <meta
    name="description"
    content="Find answers to frequently asked questions about Skill Naav — internship discovery, platform usage, pricing, instructor assignment, and how to get started."
  />
</Helmet>
      <Navbar />
