      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            className={inputCls}
          >
            <option value="" disabled>InternshipType</option>
            <option value="FREE">Free</option>
            <option value="STIPEND">Stipend</option>
          </select>

          {(formData.internshipType === "FREE" || formData.internshipType === "STIPEND") && (
            <div className={`mt-3 px-4 py-3 rounded-xl border flex items-center ${
              formData.internshipType === "STIPEND"
                ? "bg-emerald-50/60 border-emerald-100"
                : "bg-slate-50 border-slate-200"
            }`}>
              <span className="text-lg mr-3 leading-none">
                {formData.internshipType === "STIPEND" ? "" : ""}
              </span>
          ...
          <div className="mt-4">
            <label className={`flex h-11 items-center px-3 border rounded-lg transition-all ${userType === "Freemium" ? "opacity-50 cursor-not-allowed bg-gray-50 border-gray-200" : formData.internshipType === 'PAID' ? 'border-teal-500 bg-teal-50 ring-1 ring-teal-500 cursor-pointer' : 'border-gray-300 hover:bg-gray-50 cursor-pointer'}`}>
              <input
                type="radio"
                name="internshipType"
                value="PAID"
          ...
          {/* Helper text */}
          {false && formData.internshipType === "FREE" && (
            <div className="mt-4 px-4 py-3 bg-gray-50/80 rounded-xl border border-gray-200 flex items-center">
              <span className="text-lg mr-3 leading-none"></span>
              <p className="text-sm text-gray-600 leading-tight">
                <strong>Free:</strong> Students join without paying any fee and do not receive a stipend.
              </p>
            </div>
          )}
          {false && formData.internshipType === "STIPEND" && (
            <div className="mt-4 px-4 py-3 bg-[#F2FCF5] rounded-xl border border-[#bbf7d0] flex items-center">
              <span className="text-lg mr-3 leading-none"></span>
              <p className="text-sm text-[#166534] leading-tight">
                <strong>Stipend:</strong> Students receive a stipend from your organization during the internship.
              </p>
            </div>
          )}
          {formData.internshipType === "PAID" && (
            <div className="mt-4 px-4 py-3 bg-orange-50/60 rounded-xl border border-blue-100 flex items-center">
              <span className="text-lg mr-3 leading-none"></span>
