...
const Sidebar = ({ isMobile, isOpen, onClose, isDesktopOpen = true }) => {
    ...
    <>
      ...
      >
        ...
        <div className="w-full h-full flex flex-col">
          ...
          {/* Scrollable nav area */}
          <div className={`flex-1 overflow-y-auto pt-4 pb-6 hide-scrollbar ${isDesktopOpen || isMobile ? "px-4" : "px-1"}`}>
  ...
  `}
            ...
            <div className="mt-6 space-y-2">
              <button
                ...
                className={`flex items-center p-3 rounded-lg w-full text-left font-medium transition-colors
    ${selectedTab === "support" ? "bg-[#F0DEFD] text-[#7520A9]" : "text-gray-600 hover:bg-gray-100"}
    ${!isDesktopOpen && !isMobile ? "justify-center" : ""}
  `}
              >
                <FontAwesomeIcon
  ...
  `}
            ...
            {/* Upgrade Box — hidden when collapsed */}
            {(isDesktopOpen || isMobile) && (
