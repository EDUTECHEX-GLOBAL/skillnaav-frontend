...
const BioTech = () => {
    ...
    const fetchSectorInternships = async () => {
      try {
        ...
        const res = await axios.get("/api/interns/approved", {
          params: { isPremium: false, sector: "biotech" }, // Filtering by sector
        });
  ...
  return (
    <div className="p-4 font-poppins">
      {/* Page Title */}
      <h1 className="text-2xl font-bold mb-2">Biotechnology Internships ({internships.length})</h1>

      {/* Short description */}
      <p className="text-gray-600 mb-4">
        Explore the latest opportunities in the field of Biotechnology and Synthetic Biology.
      </p>
