    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mt-6 sm:mt-8">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
        ...
        <ResponsiveContainer width="100%" height={isMobile ? 220 : 250}>
          <LineChart data={userGrowth} margin={{ top: 8, right: 10, left: isMobile ? -20 : 0, bottom: 0 }}>
      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
        <h3 className="text-base sm:text-lg font-semibold mb-4">Monthly Job Postings</h3>
        <ResponsiveContainer width="100%" height={isMobile ? 220 : 250}>
          <BarChart data={jobPostings} margin={{ top: 8, right: 10, left: isMobile ? -20 : 0, bottom: 0 }}>
            <XAxis dataKey="month" tick={{ fontSize: isMobile ? 10 : 12 }} minTickGap={isMobile ? 18 : 10} />
            <YAxis width={isMobile ? 28 : 40} tick={{ fontSize: isMobile ? 10 : 12 }} />
            <Tooltip />
            <CartesianGrid strokeDasharray="3 3" />
