...
const PAGE_SIZE = 20; // partners rendered per batch
...
const PartnerPayments = () => {
  ...
  // ── Reset visible window on search change ────────────────────────────────────
  useEffect(() => {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-9 py-2.5 text-sm border border-gray-200 rounded-xl bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition"
          />
          {search && (
            <button
              onClick={() => setSearch("")}
              ...
              <>
                ...
                {filteredPartners.length > PAGE_SIZE && (
                  <p className="text-[10px] text-gray-400 mb-2 text-right pr-1">
                    Showing {visiblePartners.length} of {filteredPartners.length}
                  </p>
                )}
                ...
                >
                  ...
                  {!hasMore && filteredPartners.length > PAGE_SIZE && (
                    <p className="text-center text-[11px] text-gray-400 py-2 border-t border-gray-100 mt-1">
